...
- **ملفات Xcode غير المرغوبة** — DerivedData والأرشيفات وذاكرة التخزين المؤقت للمحاكيات وأنظمة تشغيل المحاكي المحمّلة (تُحذف عبر `simctl runtime delete`؛ لا تُحدد تلقائيًا أبدًا)
