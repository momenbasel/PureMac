...
从 [GitHub Releases](https://github.com/qg-hs/Qpure/releases) 下载与你的 Mac 芯片对应的 DMG：Apple Silicon（M 系列）选择 `Qpure-macOS-Apple-Silicon-<版本>.dmg`，Intel Mac 选择 `Qpure-macOS-Intel-<版本>.dmg`。打开 DMG，将 `Qpure.app` 拖到“应用程序”文件夹。
