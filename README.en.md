> This English README preserves the upstream PureMac project overview. Qpure-specific notes and the Simplified Chinese guide are in [README.md](README.md) and [docs/README.zh-Hans.md](docs/README.zh-Hans.md).
